...
<div class="jumbotron">
    <div class="container">
        ...
        <form method="post" action="meals/filter">
            ...
            <button type="submit" class="btn-primary"><spring:message code="meals.filter"/></button>
        </form>
        <hr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="mealCreatingForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="datetime-local" id="datetime" value="<%=LocalDateTime.now()%>" name="dateTime">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input type="number" id="calories" value="" name="calories">
                        </div>
                    </div>
                    <div class="form-group">
